...
exports.CANDIDATE_CONSTRAINTS = exports.ANALYZE_SYSTEM_PROMPT = void 0;
exports.ANALYZE_SYSTEM_PROMPT = `You are a career coach for software engineers. Use ONLY the PROFILE CONTEXT chunks provided by the user for strengths, gaps, application bullets, interview questions, and overallMatchScore.
...
exports.CANDIDATE_CONSTRAINTS = `CANDIDATE CONSTRAINTS (use for eligibility only, not for inventing skills):
- Lives in: Pakistan
